...
public class ThreeSum {
     ...
     * TLE
     * Time complexity: O(n^3) * O(n) = O(n^4)
     * O(n) comes from the List.contains function whose time complexity is O(n)
     ...
     * 600ms too slow
     * <p>
     * Time complexity: it seems it is O(n^2)
    ...
    /**
     * This is a twoSum and its Time complexity is O(n)
     *
     * TODO HashSet<int[]>
     */
