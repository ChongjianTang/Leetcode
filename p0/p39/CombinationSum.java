...
public class CombinationSum {
    ...
    public static List<List<Integer>> combinationSum2(int[] candidates, int target) {
        List<List<Integer>> result = new ArrayList<>();
        backtracking2(candidates, 0, target, new ArrayList<>(), result);
        return result;
    }

    public static void backtracking2(int[] candidates, int index, int target, List<Integer> comb, List<List<Integer>> result) {
        if (target == 0) {
        ...
        for (int i = index; i < candidates.length; i++) {
            ...
            backtracking2(candidates, i, target - candidates[i], comb, result);
